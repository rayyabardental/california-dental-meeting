...
export function Included(): React.ReactElement {
  return (
    <section
      id="included"
      aria-label="What's included and clinical team structure"
        ...
        <div className="grid gap-14 lg:grid-cols-[1.2fr_1fr] lg:items-start">
          <div>
            ...
            <p className="mt-5 max-w-xl text-lg text-ink-muted text-pretty">
              The {FLAGSHIP_COURSE.title} is fully inclusive — hotel,
              transportation, scrubs, materials, daily lunch, and the closing
              graduation dinner are all part of the programme.
            </p>

            <ul className="mt-10 grid gap-3 sm:grid-cols-2">
              {FLAGSHIP_COURSE.whatsIncluded.map((item, i) => (
                <motion.li
                  key={item}
          ...
          <div className="space-y-6 lg:sticky lg:top-24">
            <div className="rounded-3xl border border-primary/10 bg-white p-7 shadow-[0_1px_2px_rgba(13,35,64,0.04)]">
              ...
              <ol className="mt-5 space-y-3">
                {FLAGSHIP_COURSE.clinicalTeam?.map((role, i) => (
                  <li
                    key={role.role}
